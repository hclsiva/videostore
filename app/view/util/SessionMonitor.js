 ...
 * logged out.
 */
Ext.define('masteringextjs.view.util.SessionMonitor', {
  singleton: true,

  interval: 1000 * 10,  // run every 10 seconds.
  lastActive: null,
  maxInactive: 1000 * 60 * 1, //1000 * 60 * 15,  // 15 minutes of inactivity allowed; set it to 1 for testing.
  remaining: 0,
  ui: Ext.getBody(),
  ...
  window: Ext.create('Ext.window.Window', {
    ...
    buttons: [{
      ...
      handler: function() {
        Ext.TaskManager.stop(masteringextjs.util.SessionMonitor.countDownTask);
        masteringextjs.util.SessionMonitor.window.hide();
        masteringextjs.util.SessionMonitor.start();
